...
public class GalagaGame extends JPanel implements KeyListener{
	...
	public GalagaGame() {
		...
		try {
			shotImage = ImageIO.read(new File("E:\\work_java\\javaProject\\src\\ch22_oracle_jdbc\\galaga\\fire.png"));
			shipImage = ImageIO.read(new File("E:\\work_java\\javaProject\\src\\ch22_oracle_jdbc\\galaga\\starship2.png"));
			alienImage = ImageIO.read(new File("E:\\work_java\\javaProject\\src\\ch22_oracle_jdbc\\galaga\\starship.png"));
		} catch (Exception e) {
			e.printStackTrace();
		}
		this.requestFocus();
